...
type (
	DataFinder interface {
		Names(ctx context.Context, name string, strong bool) ([]entity.Person, error)
	}

	PersonRepo interface {
		Names(ctx context.Context, firstName string, lastName string, strong bool) ([]entity.Person, error)
	}
)
